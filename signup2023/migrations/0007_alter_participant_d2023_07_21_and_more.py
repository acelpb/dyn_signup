    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                help_text="Nous cherchons des signaleurs, des capitaines de route. Si vous avez des talents de mécanicien, de secouriste, ou si vous vous proposez pour animer une activité en soirée,merci de nous le faire savoir.",
                max_length=300,
