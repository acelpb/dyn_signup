...
from signup2022.ovh import MailingList
...
class SyncEmails(forms.Form):
    sync = forms.ChoiceField(choices=(
...
class SyncMailingListFormView(AdminRequiredMixin, views.generic.FormView):
    ...
    success_url = reverse_lazy("admin:signup2022_participant_changelist")

    @cached_property
    def mailing_list(self):
        return MailingList("participants2022")
